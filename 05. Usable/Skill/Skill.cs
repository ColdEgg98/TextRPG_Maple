...
namespace TextRPG_Maple._05._Usable.Skill
{
    ...
    internal class Skill : Usable
    {
        ...
        {
            new Skill("슬래시 블러스트", 3, SkillType.전사, 2, "적에게 공격력의 2배만큼 피해를 입힙니다.", 10),
            new Skill("브랜디쉬", 6, SkillType.전사, 2.5f, "적에게 공격력의 2.5배만큼 피해를 입힙니다.", 20),
            new Skill("오라블레이드", 9, SkillType.전사, 3f, "계수 3배.", 0)
        };

        public static List<Skill> Thief_skillSet = new List<Skill>
        {
            new Skill("스킬명1", 3, SkillType.도적, 2, "적에게 공격력의 2배만큼 피해를 입힙니다.", 10),
            new Skill("스킬명2", 6, SkillType.도적, 2.5f, "적에게 공격력의 2.5배만큼 피해를 입힙니다.", 20),
            new Skill("스킬명3", 9, SkillType.도적, 0.5f, "살살 때립니다.", 0)
        };
    }
}
